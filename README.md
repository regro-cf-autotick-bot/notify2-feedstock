...
Once the `conda-forge` channel has been enabled, `notify2` can be installed with:

```
conda install notify2
```

It is possible to list all of the versions of `notify2` available on your platform with:
